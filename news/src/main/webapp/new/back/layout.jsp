...
<body>
 ...
 -->
	...
	<script type="text/javascript">
	    ...
	    console.log(num)
	    $.get("${PATH}/category/findOne/"+num,function(data){
				console.log(data); 
				$.get("${PATH}/category/findLike/"+data.cName,function(data){
					console.log(data);
					data.forEach((item)=>{
						var n = item.nTitle;
						var k = n.substring(0,22);
						if(n.length > 22){
							k = n.substring(0,22)+"...";
						}
						
						var w =  $('<h4 class="clickIt"></h4>').append(k)
						...
						$('<div class="col-md-4" style="margin-top: 1%;cursor: pointer;"></div>').append(c).appendTo(".aaaaaaaa")
						d = "";
					}) 
				},"json");
		},"json");
